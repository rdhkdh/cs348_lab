...
#define INTEGER_NUMBER 273
#define REAL_NUMBER 274
...
{
#line 41 "yaccfile.y"
int int_num; float real_num; char id[500];
...
{
       0,    66,    66,    68,    70,    70,    70,    72,    74,    74,
      76,    76,    78,    78,    80,    80,    80,    80,    80,    82,
      99,   100,   101,   103,   104,   105,   107,   118,   128,   139,
     141,   143,   145,   161,   161
};
#endif
...
{
  "$end", "error", "$undefined", "PROGRAM", "VAR", "BEGIN_TOKEN", "END",
  "PROGRAM_END", "INTEGER", "REAL", "FOR", "READ", "WRITE", "TO", "DO",
  "ASSIGNMENT", "DIVIDE", "IDENTIFIER", "INTEGER_NUMBER", "REAL_NUMBER",
  "';'", "':'", "','", "'+'", "'-'", "'*'", "'('", "')'", "$accept",
  "prog", "prog_name", "dec_list", "dec", "type", "id_list", "stmt_list",
  "stmt", "assign_stmt", "expression", "term", "factor", "read_stmt",
  "write_stmt", "for_stmt", "index_exp", "body", YY_NULLPTR
};
#endif
...
{
       6,    16,    41,   -40,    44,   -40,     1,   -40,   -40,     2,
     -40,    18,     3,    34,    20,    35,   -40,    36,    28,    29,
      42,    -1,   -40,   -40,   -40,   -40,   -40,   -40,   -40,   -40,
     -40,   -40,    43,    45,    34,    34,    19,   -40,     3,    19,
       0,   -19,     4,   -40,   -40,   -40,    21,     7,   -40,   -40,
      11,     3,   -40,   -40,   -40,   -40,    19,    19,    19,    19,
      19,    10,     7,     7,   -40,   -40,    21,   -40
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,    12,    14,    15,    16,    17,     5,     8,     9,
       7,    11,     0,     0,     0,     0,     0,     2,     0,     0,
       0,     0,     0,    26,    27,    28,    19,    20,    23,    13,
       0,     0,    33,    31,    29,    30,     0,     0,     0,     0,
       0,     0,    21,    22,    25,    24,    32,    34
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -40,   -40,   -40,   -40,    47,   -40,     8,     5,   -13,   -40,
     -39,   -10,    -9,   -40,   -40,   -40,   -40,   -40
};
...
{
      50,    16,     7,    15,    16,    51,    37,    12,    54,     1,
      17,    18,    19,    17,    18,    19,    67,    20,     8,    38,
      20,    66,    13,    58,    60,    49,    15,    52,    28,    29,
      38,    55,    59,     3,    56,    57,    43,    44,    45,    14,
      15,     5,    41,    42,    56,    57,    62,    63,     6,    64,
      65,     8,    31,    32,    34,    35,    61,    36,    39,    40,
      27
};

static const yytype_int8 yycheck[] =
{
      39,     1,     1,    22,     1,     5,     7,     5,    27,     3,
      10,    11,    12,    10,    11,    12,     6,    17,    17,    20,
      17,    60,    20,    16,    13,    38,    22,    40,     8,     9,
      20,    27,    25,    17,    23,    24,    17,    18,    19,    21,
      22,     0,    34,    35,    23,    24,    56,    57,     4,    58,
      59,    17,    17,    17,    26,    26,    51,    15,    15,    14,
      13
};
...
{
       0,     3,    29,    17,    30,     0,     4,     1,    17,    31,
      32,    34,     5,    20,    21,    22,     1,    10,    11,    12,
      17,    35,    36,    37,    41,    42,    43,    32,     8,     9,
      33,    17,    17,    44,    26,    26,    15,     7,    20,    15,
      14,    34,    34,    17,    18,    19,    38,    39,    40,    36,
      38,     5,    36,    45,    27,    27,    23,    24,    16,    25,
      13,    35,    39,    39,    40,    40,    38,     6
};
...
#line 1415 "y.tab.c"
  ...
  case 7:
#line 72 "yaccfile.y"
                       {insertall_identifiers((yyvsp[-2].id),(yyvsp[0].int_num));}
#line 1421 "y.tab.c"
    break;
...
#line 1433 "y.tab.c"
  ...
  case 11:
#line 76 "yaccfile.y"
                                              {concatenate((yyvsp[-2].id), (yyvsp[0].id), (yyval.id));}
#line 1439 "y.tab.c"
    break;
...
#line 82 "yaccfile.y"
                                               {
			int type;
			get_identifier_type((yyvsp[-2].id), &type);
...
#line 107 "yaccfile.y"
			...
			int type;
			get_identifier_type((yyvsp[0].id), &type);
...
#line 1506 "y.tab.c"
  ...
  case 29:
#line 139 "yaccfile.y"
                                 {verify_list_of_identifiers((yyvsp[-1].id));}
#line 1512 "y.tab.c"
    break;
